...
open class IMUIMessageModel: NSObject, IMUIMessageModelProtocol {
  ...
  public init(msgId: String,messageID: Int, messageStatus: IMUIMessageStatus, fromUser: IMUIUserProtocol, isOutGoing: Bool, time: String, type: String, cellLayout: IMUIMessageCellLayoutProtocol, duration: CGFloat?) {
    self.msgId = msgId

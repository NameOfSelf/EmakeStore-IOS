...
open class IMUINewInputView: UIView{
    ...
    @IBAction func switchToMicroOption(_ sender: Any) {
        self.inputTextView.resignFirstResponder()
        self.functionView.layoutFeature(with: .voice, isOffcial: self.isOffcial)
    ...
    @IBAction func switchToEmojiOption(_ sender: Any) {
        self.inputTextView.resignFirstResponder()
        self.functionView.layoutFeature(with: .emoji, isOffcial: self.isOffcial)
    ...
    @IBAction func switchToMoreOption(_ sender: Any) {
        self.inputTextView.resignFirstResponder()
        self.functionView.layoutFeature(with:.option, isOffcial: self.isOffcial)
...
extension IMUINewInputView: IMUINewFeatureViewDelegate {
    ...
    public func didSelectedEndServers() {
    ...
    public func didSelectedOrder() {
        ...
        self.inputViewDelegate?.didSelectOrder?()
    }

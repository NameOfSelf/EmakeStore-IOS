...
class IMUINewFeatureView: UIView {
    ...
    open func layoutFeature(with type: IMUINewFeatureType,isOffcial:Bool) {
        if currentType == type {
            return
        }
        currentType = type
        ...
        switch type {
            case .voice:
                ...
                break
            case .option:
                self.layoutToOption(isOffcial: isOffcial)
                break
            case .emoji:
                self.layoutToEmoji()
                break
    ...
    func layoutToOption(isOffcial:Bool) {
...
extension IMUINewFeatureView: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.activateMedia()
        cell.reloadOptionView(isOffcial: self.isOffcial)

...
class STOrderDetailItemCell: UITableViewCell {
    ...
    private func configSubViews() {
        ...
        self.protocolButton?.layer.cornerRadius = 1
    ...
    private func snapSubViews() {
        ...
        self.protocolButton?.snp.makeConstraints({ (make) in
            make.left.equalTo(WidthRate(actureValue: 12))
            make.width.equalTo(WidthRate(actureValue: 70))
            make.height.equalTo(HeightRate(actureValue: 24))

...
enum APIManager {
    ...
    case searchUser(parameter:NSDictionary)
    case getStoreDetail(parameter:NSDictionary)
    case getQuickReplay()
...
extension APIManager: TargetType{
    ...
    var path : String{
        ...
        case .searchUser(_):
            return EmakeAPI_AppStoreGetusers
        case .getStoreDetail(_):
            return EmakeAPI_AppStoreDetail
        case .getQuickReplay(_):
            return EmakeAPI_WebQuickReplay
        case .getContractPDF:
    ...
    var task : Task{
        ...
        case .searchUser(let param):
            params = param as! [String : Any]
            return .requestCompositeData(bodyData: "".data(using: String.Encoding.utf8)!, urlParameters: params)
        case .getStoreDetail(let param):
            params = param as! [String : Any]
            return .requestCompositeData(bodyData: "".data(using: String.Encoding.utf8)!, urlParameters: params)
        case .getContractPDF(let param):
            params = param as! [String : Any]
            return .requestCompositeData(bodyData: "".data(using: String.Encoding.utf8)!, urlParameters: params)
